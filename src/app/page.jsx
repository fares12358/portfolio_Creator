    ...
    <div className="container border-black mx-auto w-full h-[calc(100%-70px)] flex flex-col items-start  justify-start overflow-y-auto overflow-x-hidden no_scrollbar">
      <div className="w-full h-fit flex xl:flex-row flex-col items-start justify-start lg:px-52 px-5 sm:px-10 lg:pt-10 lg:mb-20">
        <div className="flex-1 h-full w-full order-1 xl:order-0 ">
          ...
          <p className="md:text-[18px] text-[12px] w-[500px] max-w-full leading-loose text-gray-800 font-medium">Creating a portfolio has never been easier. <br /> With a wide range of designs to choose from,<br /> you can quickly customize your portfolio to reflect your personality and professional expertise.</p>
      ...
      <div className="w-full h-fit text-center lg:my-15 my-10 flex flex-col items-center gap-10 justify-center lg:px-52 px-5 sm:px-10 lg:pt-10 lg:mb-20">
        ...
        <ul className="flex flex-col items-start text-start justify-center gap-6 lg:text-xl text-sm text-gray-800 list-disc font-medium">
      ...
      <div className=" mb-10 lg:mb-20 w-full p-10 flex flex-col gap-5 items-center justify-center">
        ...
        <div className="grid lg:grid-cols-3 gap-5 mt-10">
          <div className="flex flex-col justify-start items-center shadow-md text-center gap-1 h-[250px] w-[250px] p-5">
            ...
            <p className="text-sm font-medium">Impress your prospective clients and employers with your skills and experience. With our online portfolio maker, you can freely showcase your career highlights with just a few clicks.</p>
          </div>
          <div className="flex flex-col justify-start items-center shadow-md text-center gap-1  h-[250px] w-[250px] p-5">
            <h2 className="text-md font-bold text-wrap">Make your portfolio stand out with unique design elements</h2>
            <p className="text-sm font-medium">Create an online portfolio that plays up your achievements visually. Choose the right fonts and design elements to convey your personality and differentiate yourself from competitors.</p>
          </div>
          <div className="flex flex-col justify-start items-center shadow-md text-center gap-3 h-[250px] w-[250px] p-5">
            ...
            <p className="text-sm font-medium">Access our online portfolio maker to polish up your online portfolio for free directly on your browser using your mobile or desktop device.</p>
          </div>
        </div>
      </div>
    </div>
